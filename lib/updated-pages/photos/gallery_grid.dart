        ...
        SliverGridCount(children: [
          prescriptions.isEmpty
              ...
              : GridViewCount(
                  ...
                  (index) => _buildPhotoListItem(context, prescriptions[index]),
                ))
        ]),
          ...
          children: [
            receipts.isEmpty
                ...
                : GridViewCount(
                    children: List.generate(
                    receipts.length,
                    (index) => _buildPhotoListItem(context, receipts[index]),
                  ))
          ],
        ),
          ...
          children: [
            maintenance.isEmpty
                ...
                : GridViewCount(
                    children: List.generate(
                    maintenance.length,
                    (index) => _buildPhotoListItem(context, maintenance[index]),
                  ))
          ],
        ),
          ...
          children: [
            medicalCertificates.length == 0
                ...
                : GridViewCount(
                    ...
                    (index) => _buildPhotoListItem(
                        context, medicalCertificates[index]),
                  ))
          ],
        ),
        ...
        SliverGridCount(
          children: [
            others.isEmpty
                ? noAvailable()
                : GridViewCount(
                    children: List.generate(others.length,
                        (index) => _buildPhotoListItem(context, others[index])))
          ],
        ),
      ],
    );
    ...
    return Container(
      child: GestureDetector(
          child: Hero(
            ...
            child: GridTile(
              footer: Container(
                  child: Text('File name: ${document.fileName}',
