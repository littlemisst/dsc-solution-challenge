    ...
    return Container(
      ...
      child: Row(children: <Widget>[
        ...
        ? CircleAvatar(
          ...
          radius: 25, backgroundColor: Theme.of(context).primaryColor)
        :  CircleAvatar(
          radius: 25,
      ...
      child: Column(
        children: <Widget>[
          ItemContainer(
            top: 20,
            bottom: 20,
            child: _userProfile(_currentProfile.downloadUrl, _user.email, (_currentProfile.name).substring(0, 1))),
          Expanded(child: ItemContainer(
            ...
            child: Column(children: <Widget>[
              ListItem(
                ...
                onTap: () async =>  Navigator.popAndPushNamed(context, Strings.profilePageRoute),
              ),
              ListItem(
                icon: Icons.message, 
                text: Strings.message,
                onTap: () async =>  Navigator.popAndPushNamed(context, Strings.messagesPage),
              ),
              ListItem(
                icon: Icons.share, 
                text: Strings.shareDetails, 
                onTap: () async => Navigator.popAndPushNamed(context, Strings.sendDetailsRoute),
              ),
            ])
          )),
          ItemContainer(top: 0, bottom: 0,
            child: ListItem(
              icon: Icons.help, 
              text: Strings.help,
              onTap: () => Navigator.popAndPushNamed(context, Strings.helpPage))
          ),
          ItemContainer(top: 0, bottom: 0,
            child: ListItem(
